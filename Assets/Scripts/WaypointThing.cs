...
public class WaypointThing : MonoBehaviour
{
    ...
    public void Add()
    {
        ...
        {
            CreateNewPoint(new Vector3(Waypoints[Waypoints.Count - 1].x + 0.5f, Waypoints[Waypoints.Count - 1].y, Waypoints[Waypoints.Count - 1].z));
        }
        else
        {
            CreateNewPoint(new Vector3(transform.position.x + 0.5f, transform.position.y, transform.position.z));
        }
    }

    private void CreateNewPoint(Vector3 pos)
    {
        Waypoints.Add(pos);
    }
